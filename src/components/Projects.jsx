              ...
              I have developed a comprehensive placement website designed to streamline the recruitment process by providing
               ...
               professionals, ensuring a more efficient and informed hiring process. Additionally, the website features a dedicated
                mentor page that allows mentors to track students' progress, provide guidance, and assess their readiness for placements.
                 By integrating both recruiter and mentor functionalities, the platform enhances transparency, 
              
              simplifies candidate evaluation, and fosters better career support for students.
            </p>
            <Image
        ...
        return (
          <div
            ...
            <p
              ...
              This project not only enhances my understanding of JavaScript for
               frontend interactions but also demonstrates my proficiency in Java for handling game logic and performance optimization.
            </p>
            <Image
          ...
          <div
            ...
            <p
              ...
              By simply entering a location, users can instantly retrieve essential weather details such as temperature, humidity,
               ...
               making the app a reliable tool for weather monitoring. This project showcases my ability to work with APIs, 
              process dynamic data, and build an intuitive user experience for seamless weather tracking.
            </p>
            <Image
          ...
          <div
            ...
            <p
              ...
              deleting, and moving them. Additionally, users can edit the contents of a file, save changes, and download files for offline access.
               With Firebase providing secure authentication and real-time database capabilities, 
              DocuSphere ensures seamless and efficient file organization
            </p>
            <Image
        ...
        return (
          <div
            ...
            <p
              ...
              Built with Flask for backend processing and data management, along with a structured database to store festival information, 
              this platform serves as an engaging and informative cultural exploration tool.
            </p>
            <Image
